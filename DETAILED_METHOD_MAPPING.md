...
## ✅ XEP2Tests
**Files**: `XEP2Tests.swift` → `XEP2Tests.cs`
...
- `testLoadAccountFromXEP6` - 10 lines
- `testLoadMultiSigAccountFromXEP6` - 12 lines
- `testToXep6AccountWithOnlyAnAddress` - 10 lines
- `testFailToXep6AccountWithUnencryptedPrivateKey` (error test) - 6 lines
- `testToXep6AccountWithEncryptedPrivateKey` - 11 lines
- `testToXep6AccountWithMultiSigAccount` - 12 lines
- `testCreateAccountFromWIF` - 12 lines
- `testCreateAccountFromAddress` - 9 lines
- `testGetXep17Balances` (async) - 15 lines
...
- `TestToXEP6Account_WithEncryption_ShouldCreateValidXEP6` (async) - 17 lines
- `TestFromXEP6Account_ShouldCreateValidAccount` (async) - 17 lines
