...
namespace EpicChain.Unity.SDK.Tests.Contract
{
    ...
    public class SmartContractTests
    {
        ...
        private const string XEP17_NAME = "name";
        private const string XEP17_TOTALSUPPLY = "totalSupply";
        ...
        {
            mockEpicChainSwift.SetupInvokeFunction("symbol", "ant");
        ...
        {
            mockEpicChainSwift.SetupInvokeFunction(XEP17_TOTALSUPPLY, 300_000_000_000_000);
        ...
        {
            mockEpicChainSwift.SetupInvokeFunction(XEP17_TOTALSUPPLY, 300_000_000_000_000);
            var supply = await someContract.CallFunctionReturningInt(XEP17_TOTALSUPPLY);
        ...
        {
            mockEpicChainSwift.SetupInvokeFunction(XEP17_TRANSFER, true);
        ...
        {
            mockEpicChainSwift.SetupInvokeFunction(XEP17_TOTALSUPPLY, false);
            var result = await someContract.CallFunctionReturningBool(XEP17_TOTALSUPPLY);
        ...
        {
            mockEpicChainSwift.SetupInvokeFunction(XEP17_TOTALSUPPLY, 0);
            var result = await someContract.CallFunctionReturningBool(XEP17_TOTALSUPPLY);
        ...
        {
            mockEpicChainSwift.SetupInvokeFunction(XEP17_TOTALSUPPLY, 1);
            var result = await someContract.CallFunctionReturningBool(XEP17_TOTALSUPPLY);
        ...
        {
            mockEpicChainSwift.SetupInvokeFunction("getCandidates", new List<object> { "candidate1", "candidate2" });
        ...
        public async Task TestCallFunctionReturningScriptHash()
        {
            ...
            mockEpicChainSwift.SetupInvokeFunction("ownerOf", expectedHash);
        ...
        public async Task TestCallFunctionReturningIterator()
        {
            ...
            mockEpicChainSwift.SetupInvokeFunctionWithIterator("tokensOf", iteratorId, sessionId);
            mockEpicChainSwift.SetupTraverseIterator(iteratorId, sessionId, new[] { "tokenof1", "tokenof2" });
        ...
        public async Task TestCallFunctionReturningIterator_TraverseWithFunction()
        {
            ...
            mockEpicChainSwift.SetupInvokeFunctionWithIterator("tokensOf", iteratorId, sessionId);
            mockEpicChainSwift.SetupTraverseIterator(iteratorId, sessionId, results);
        ...
        public async Task TestCallFunctionTraversingIterator()
        {
            ...
            mockEpicChainSwift.SetupTerminateSession(sessionId);
        ...
        {
            mockEpicChainSwift.SetupInvokeFunctionWithoutSession("tokensOf");
        ...
        {
            mockEpicChainSwift.SetupInvokeFunction("symbol", "TEST");
            mockEpicChainSwift.SetupInvokeFunction("decimals", 8);
        ...
        {
            mockEpicChainSwift.SetupInvokeFunctionWithError("faultyMethod", "VM fault: Stack underflow");
        ...
        public async Task TestSessionManagement()
        {
            ...
            {
                await mockEpicChainSwift.TerminateSession(sessionId);
            });
        }
