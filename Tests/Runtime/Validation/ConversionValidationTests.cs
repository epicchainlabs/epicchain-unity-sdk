...
using EpicChainUnityRuntime.Protocol;
using EpicChainUnityRuntime.Protocol.Response;
using EpicChainUnityRuntime.Reactive;

namespace EpicChainUnityTests.Runtime.Validation
{
    /// <summary>
    ...
    public class ConversionValidationTests
    {
        ...
        public void IEpicChainExpress_Interface_IsValid()
        {
            ...
            Assert.Contains("ExpressGetXep17Contracts", methodNames);
