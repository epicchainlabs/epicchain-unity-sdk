...
namespace EpicChain.Unity.SDK.Tests.Helpers
{
    ...
    public class MockNeoSwift : INeoUnity
    {
        ...
        public async Task<EpicChainGetBlockHashResponse> GetBlockHash(int blockIndex)
        {
            _requestInterceptor?.Invoke(CreateRequest("getblockhash", blockIndex));
            return new EpicChainGetBlockHashResponse { Result = $"mock_block_hash_{blockIndex}" };
        }

        public async Task<EpicChainGetBlockResponse> GetBlock(int blockIndex, bool fullTransactionObjects = true)
        {
        ...
        public async Task<EpicChainGetBlockResponse> GetBlock(Hash256 blockHash, bool fullTransactionObjects = true)
        {
            var method = fullTransactionObjects ? "getblock" : "getblockheader";
        ...
        public async Task<EpicChainGetBlockCountResponse> GetBlockCount()
        {
        ...
        public async Task<EpicChainGetContractStateResponse> GetContractState(Hash160 contractHash)
        {
            ...
            if (_mockResponses.ContainsKey("getcontractstate"))
                return _mockResponses["getcontractstate"] as EpicChainGetContractStateResponse;
                
            return new EpicChainGetContractStateResponse { Manifest = new ContractManifest { Name = "mock_contract" } };
        }

        public async Task<EpicChainGetContractStateResponse> GetNativeContractState(string contractName)
        {
            _requestInterceptor?.Invoke(CreateRequest("getcontractstate", contractName));
            return new EpicChainGetContractStateResponse { Manifest = new ContractManifest { Name = contractName } };
        }

        public async Task<EpicChainGetMemPoolResponse> GetMemPool()
        {
            _requestInterceptor?.Invoke(CreateRequest("getrawmempool", 1));
            return new EpicChainGetMemPoolResponse { Result = new MemPool() };
        }

        public async Task<EpicChainGetRawMemPoolResponse> GetRawMemPool()
        {
            _requestInterceptor?.Invoke(CreateRequest("getrawmempool"));
            return new EpicChainGetRawMemPoolResponse { Result = new List<string>() };
        }
        ...
        public async Task<EpicChainGetStorageResponse> GetStorage(Hash160 contractHash, string key)
        {
            ...
            return new EpicChainGetStorageResponse { Result = "mock_storage_value" };
        }

        public async Task<EpicChainGetTransactionHeightResponse> GetTransactionHeight(Hash256 transactionHash)
        {
            _requestInterceptor?.Invoke(CreateRequest("gettransactionheight", transactionHash.ToString()));
            return new EpicChainGetTransactionHeightResponse { Result = 12345 };
        }

        public async Task<EpicChainGetNextBlockValidatorsResponse> GetNextBlockValidators()
        {
            _requestInterceptor?.Invoke(CreateRequest("getnextblockvalidators"));
            return new EpicChainGetNextBlockValidatorsResponse { Result = new List<string>() };
        }

        public async Task<EpicChainGetCommitteeResponse> GetCommittee()
        {
            _requestInterceptor?.Invoke(CreateRequest("getcommittee"));
            return new EpicChainGetCommitteeResponse { Result = new List<string>() };
        }

        public async Task<EpicChainGetConnectionCountResponse> GetConnectionCount()
        {
            _requestInterceptor?.Invoke(CreateRequest("getconnectioncount"));
            return new EpicChainGetConnectionCountResponse { Result = 10 };
        }

        public async Task<EpicChainGetPeersResponse> GetPeers()
        {
            _requestInterceptor?.Invoke(CreateRequest("getpeers"));
            return new EpicChainGetPeersResponse { Result = new Peers() };
        }

        public async Task<EpicChainGetVersionResponse> GetVersion()
        {
        ...
        public async Task<EpicChainGetXep17TransfersResponse> GetXep17Transfers(Hash160 accountHash, DateTime? fromDate = null, DateTime? toDate = null)
        {
            ...
            _requestInterceptor?.Invoke(CreateRequest("getxep17transfers", parameters.ToArray()));
            return new EpicChainGetXep17TransfersResponse { Result = new Xep17Transfers() };
        }

        public async Task<EpicChainGetXep17BalancesResponse> GetXep17Balances(Hash160 accountHash)
        {
            _requestInterceptor?.Invoke(CreateRequest("getxep17balances", accountHash.ToAddress()));
        ...
        public async Task<EpicChainGetStateRootResponse> GetStateRoot(int blockIndex)
        {
            ...
            return new EpicChainGetStateRootResponse { Result = new StateRoot() };
        }

        public async Task<EpicChainGetStateHeightResponse> GetStateHeight()
        {
            _requestInterceptor?.Invoke(CreateRequest("getstateheight"));
            return new EpicChainGetStateHeightResponse { Result = new StateHeight() };
        }
