...
namespace EpicChain.Unity.SDK.Tests.Wallet
{
    /// <summary>
    /// Unit tests for the EpicChainWallet class.
    /// Tests wallet creation, account management, and XEP-6 compatibility.
    /// </summary>
    [TestFixture]
    public class EpicChainWalletTests
    {
        private Account testAccount1;
        private Account testAccount2;
        private EpicChainWallet testWallet;
        ...
        public async Task SetUp()
        {
            ...
            // Create test wallet
            testWallet = new EpicChainWallet("TestWallet");
        }
        ...
        public void TestWalletConstructor_WithName_ShouldCreateValidWallet()
        {
            ...
            // Act
            var wallet = new EpicChainWallet(walletName);
        ...
        {
            // Act
            var wallet = await EpicChainWallet.Create();
        ...
        public async Task TestCreateWithPassword_ShouldCreateEncryptedWallet()
        {
            ...
            // Act
            var wallet = await EpicChainWallet.Create(password);
        ...
        {
            // Act
            var wallet = EpicChainWallet.WithAccounts(testAccount1, testAccount2);
        ...
        {
            // Act & Assert
            Assert.Throws<ArgumentException>(() => EpicChainWallet.WithAccounts(), 
        ...
        #region XEP-6 Wallet File Tests
        
        [Test]
        public async Task TestToXEP6Wallet_ShouldCreateValidXEP6()
        {
            // Arrange
            testWallet.AddAccounts(testAccount1, testAccount2);
            testWallet.SetDefaultAccount(testAccount1);
            ...
            // Act
            var xep6Wallet = await testWallet.ToXEP6Wallet();
            
            // Assert
            Assert.IsNotNull(xep6Wallet, "XEP-6 wallet should not be null");
            Assert.AreEqual(testWallet.Name, xep6Wallet.Name, "Name should match");
            Assert.AreEqual(testWallet.Version, xep6Wallet.Version, "Version should match");
            Assert.AreEqual(2, xep6Wallet.Accounts.Count, "Should have 2 accounts");
            
            var defaultXep6Account = xep6Wallet.Accounts.Find(acc => acc.IsDefault);
            Assert.IsNotNull(defaultXep6Account, "Should have a default account");
            Assert.AreEqual(testAccount1.Address, defaultXep6Account.Address, "Default account should match");
        }
        
        [Test]
        public async Task TestFromXEP6Wallet_ShouldRestoreWallet()
        {
            // Arrange
            testWallet.AddAccounts(testAccount1, testAccount2);
            testWallet.SetDefaultAccount(testAccount1);
            ...
            // Act
            var restoredWallet = await EpicChainWallet.FromXEP6Wallet(xep6Wallet);
        ...
        {
            // Arrange
            var otherWallet = new EpicChainWallet("OtherWallet");
        ...
        {
            // Arrange
            var largeWallet = new EpicChainWallet("LargeWallet");
        ...
        public void TestUnitySerialization_ShouldPreserveWalletData()
        {
            ...
            var deserializedWallet = JsonUtility.FromJson<EpicChainWallet>(json);
