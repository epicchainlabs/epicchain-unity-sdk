...
{
    /// <summary>
    /// Unity Test Framework implementation of XEP6Wallet tests
    /// Converted from Swift XEP6WalletTests.swift with Unity-specific enhancements
    /// </summary>
    [TestFixture]
    public class XEP6WalletTests
    {
        [Test]
        public void TestReadWallet()
        {
            ...
            // Act
            var wallet = JsonConvert.DeserializeObject<XEP6Wallet>(walletJson);
            ...
            var parameter1 = contract1.Xep6Parameters[0];
            ...
            var parameter2 = contract2.Xep6Parameters[0];
        ...
        public void TestCreateWallet()
        {
            ...
            // Act
            var wallet = new XEP6Wallet(walletName);
        ...
        {
            // Arrange
            var wallet = new XEP6Wallet("TestWallet");
            var password = "testpassword123";
        ...
        public void TestWalletSerialization()
        {
            ...
            var deserializedWallet = JsonConvert.DeserializeObject<XEP6Wallet>(jsonString);
        ...
        public void TestPerformance_WalletCreation()
        {
            ...
            var executionTime = TestHelpers.MeasureExecutionTime(() =>
            {
                ...
                {
                    var wallet = new XEP6Wallet($"TestWallet{i}");
                    wallet.CreateAccount(password);
                    GC.KeepAlive(wallet);
                }
            });
        ...
        public IEnumerator TestUnityCoroutineCompatibility()
        {
            ...
            XEP6Wallet createdWallet = null;
            var password = "testpassword123";

            // Act - Simulate async wallet creation in coroutine
            yield return new WaitForEndOfFrame();

            createdWallet = new XEP6Wallet("CoroutineWallet");
        ...
        {
            // Test that XEP6Wallet can work with Unity serialization
            var wallet = new XEP6Wallet("InspectorWallet");
            var password = "testpassword123";
            wallet.CreateAccount(password);
        ...
        public void TestThreadSafety()
        {
            ...
            var wallet = new XEP6Wallet("ThreadSafetyWallet");
        ...
        public void TestEdgeCases_InvalidInputs()
        {
            ...
            Assert.Throws<ArgumentException>(() => new XEP6Wallet(null));
            Assert.Throws<ArgumentException>(() => new XEP6Wallet(""));
            Assert.Throws<ArgumentException>(() => new XEP6Wallet("   "));
