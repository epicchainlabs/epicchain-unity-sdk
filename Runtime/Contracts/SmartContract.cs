...
namespace EpicChain.Unity.SDK.Contracts
{
    ...
    public class SmartContract
    {
            ...
            int maxIteratorResultItems, List<Signer> signers = null)
        {
            ...
            var invocationResult = await EpicChainUnityInvokeScript(script.ToHexString(), signers ?? new List<Signer>()).SendAsync();
            var result = invocationResult.GetResult();
            ThrowIfFaultState(result);
        ...
        public async Task<EpicChainInvokeFunctionResponse> CallInvokeFunction(string function, ContractParameter[] parameters = null, List<Signer> signers = null)
        {
            ...
            return await EpicChainUnityInvokeFunction(ScriptHash, function, paramList, signers ?? new List<Signer>()).SendAsync();
        }
        ...
        {
            var response = await EpicChainUnityGetContractState(ScriptHash).SendAsync();
