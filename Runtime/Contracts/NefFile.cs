...
using EpicChain.Unity.SDK.Serialization;
...
namespace EpicChain.Unity.SDK.Contracts
{
    /*
    ┌───────────────────────────────────────────────────────────────────────┐
    │                    EPICCHAIN Executable Format 3 (XEF3)                     │
    ├──────────┬───────────────┬────────────────────────────────────────────┤
    │  Field   │     Type      │                  Comment                   │
    ├──────────┼───────────────┼────────────────────────────────────────────┤
    ...
    */
    ...
    /// <summary>
    /// Represents a EPICCHAIN Executable Format (XEF) file structure.
    /// XEF3 is the standard format for EpicChain smart contracts.
    /// </summary>
    public struct NefFile : IEpicChainSerializable
    {
        #region Constants
        
        private const uint MAGIC = 0x3346454E; // "XEF3" in little-endian
        ...
        /// </summary>
        public struct MethodToken : IEpicChainSerializable, IEquatable<MethodToken>
        {
            #region Constants
