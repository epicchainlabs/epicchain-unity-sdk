...
namespace EpicChain.Unity.SDK.Contracts.Native
{
    ...
    /// The GAS token is used to pay for transaction fees and contract execution on the EpicChain blockchain.
    /// </summary>
    [System.Serializable]
    public class EpicPulse : FungibleToken
    {
        ...
        /// <summary>
        /// Estimates the GAS cost for a simple XEP-17 token transfer.
