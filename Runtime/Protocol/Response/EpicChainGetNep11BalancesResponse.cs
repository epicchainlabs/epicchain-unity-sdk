...
{
    /// <summary>
    /// Response for GetXep11Balances RPC method.
    ...
    public class EpicChainGetXep11BalancesResponse : NeoResponse<EpicChainGetXep11BalancesResponse.Xep11Balances>
    {
        ...
        /// </summary>
        [System.Serializable]
        public class Xep11Balances
        {
            /// <summary>The address these balances belong to</summary>
            [JsonProperty("address")]
            public string Address { get; set; }
            
            /// <summary>List of XEP-11 token balances</summary>
            [JsonProperty("balance")]
            public List<Xep11Balance> Balances { get; set; }
            
            /// <summary>
            /// Default constructor.
            /// </summary>
            public Xep11Balances()
            {
                Balances = new List<Xep11Balance>();
            }
            ...
            public Xep11Balance GetBalance(Hash160 assetHash)
            {
            ...
            /// <summary>
            /// String representation of XEP-11 balances.
            /// </summary>
            /// <returns>String representation</returns>
            public override string ToString()
            {
                return $"Xep11Balances(Address: {Address}, Contracts: {GetTokenContractCount()}, Total Tokens: {GetTotalTokenCount()})";
            }
        }
        
        /// <summary>
        /// Individual XEP-11 token balance for a specific contract.
        /// </summary>
        [System.Serializable]
        public class Xep11Balance
        {
            ...
            public override string ToString()
            {
                return $"Xep11Balance(Contract: {Name} ({Symbol}), Amount: {Amount}, Hash: {AssetHash})";
            }
        }
