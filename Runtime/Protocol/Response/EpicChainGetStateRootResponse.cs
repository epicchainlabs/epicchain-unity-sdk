...
namespace EpicChain.Unity.SDK.Protocol.Response
{
    ...
    public class EpicChainGetStateRootResponse : EpicChainResponse<EpicChainGetStateRootResponse.StateRoot>
    {
        ...
        /// </summary>
        public EpicChainGetStateRootResponse() : base()
        {
        }
        ...
        public EpicChainGetStateRootResponse(StateRoot stateRoot, int id = 1) : base(stateRoot, id)
        {
        }
        ...
        /// <param name="id">The request ID</param>
        public EpicChainGetStateRootResponse(ResponseError error, int id = 1) : base(error, id)
        {
        }
