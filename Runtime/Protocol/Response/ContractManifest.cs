...
namespace EpicChain.Unity.SDK.Protocol.Response
{
    ...
    public class ContractManifest
    {
        ...
        /// <summary>List of standards this contract supports (XEP-17, XEP-11, etc.)</summary>
        ...
        /// <summary>Whether this contract supports XEP-17 token standard</summary>
        [JsonIgnore]
        public bool IsXep17Token => SupportedStandards?.Contains("XEP-17") == true;
        
        /// <summary>Whether this contract supports XEP-11 NFT standard</summary>
        [JsonIgnore]
        public bool IsXep11Token => SupportedStandards?.Contains("XEP-11") == true;
        ...
        /// </summary>
        /// <param name="standard">The standard name (e.g., "XEP-17", "XEP-11")</param>
        ...
        public List<string> GetSupportedTokenStandards()
        {
            ...
            return SupportedStandards.Where(s => s.StartsWith("XEP-")).ToList();
        }
