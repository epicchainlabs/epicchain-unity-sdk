...
namespace EpicChain.Unity.SDK.Protocol.Response
{
    ...
    public class ContractState
    {
        ...
        /// <summary>Whether this contract is a XEP-17 token</summary>
        [JsonIgnore]
        public bool IsXep17Token => Manifest?.IsXep17Token == true;
        
        /// <summary>Whether this contract is a XEP-11 NFT</summary>
        [JsonIgnore]
        public bool IsXep11Token => Manifest?.IsXep11Token == true;
        
        /// <summary>Whether this contract supports any token standard</summary>
        [JsonIgnore]
        public bool IsTokenContract => IsXep17Token || IsXep11Token;
