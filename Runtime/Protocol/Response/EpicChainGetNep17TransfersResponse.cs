...
{
    /// <summary>
    /// Response for getting XEP-17 token transfers for an address.
    ...
    public class EpicChainGetXep17TransfersResponse : NeoResponse<Xep17Transfers>
    {
        ...
        /// </summary>
        /// <returns>XEP-17 transfers or null if response failed</returns>
        public Xep17Transfers GetTransfers()
        {
    ...
    /// <summary>
    /// Represents all XEP-17 token transfers for a specific address.
    /// Contains both sent and received transfers.
    /// </summary>
    [System.Serializable]
    public class Xep17Transfers
    {
        #region Properties
        
        /// <summary>List of sent transfers</summary>
        [JsonProperty("sent")]
        public List<Xep17Transfer> Sent { get; set; }
        
        /// <summary>List of received transfers</summary>
        [JsonProperty("received")]
        public List<Xep17Transfer> Received { get; set; }
        ...
        /// </summary>
        public Xep17Transfers()
        {
            Sent = new List<Xep17Transfer>();
            Received = new List<Xep17Transfer>();
        }
        
        /// <summary>
        /// Creates new XEP-17 transfers.
        /// </summary>
        /// <param name="sent">Sent transfers</param>
        /// <param name="received">Received transfers</param>
        /// <param name="address">The address</param>
        public Xep17Transfers(List<Xep17Transfer> sent, List<Xep17Transfer> received, string address)
        {
            Sent = sent ?? new List<Xep17Transfer>();
            Received = received ?? new List<Xep17Transfer>();
            Address = address;
        }
        ...
        public List<Xep17Transfer> GetAllTransfers()
        {
            var allTransfers = new List<Xep17Transfer>();
        ...
        public List<Xep17Transfer> GetAllTransfersSortedByTime()
        {
        ...
        public List<Xep17Transfer> GetAllTransfersSortedByBlock()
        {
        ...
        public List<Xep17Transfer> GetTransfersForToken(Hash160 assetHash)
        {
            if (assetHash == null)
                return new List<Xep17Transfer>();
        ...
        /// <returns>List of transfers for the token</returns>
        public List<Xep17Transfer> GetTransfersForToken(string assetHashString)
        {
        ...
        public List<Xep17Transfer> GetTransfersInBlockRange(long fromBlock, long toBlock)
        {
        ...
        public List<Xep17Transfer> GetTransfersInTimeRange(long fromTime, long toTime)
        {
        ...
        public List<Xep17Transfer> GetTransfersAboveAmount(decimal minimumAmount)
        {
        ...
        public List<Xep17Transfer> GetRecentTransfers(int count)
        {
        ...
        public List<Xep17Transfer> GetTransfersWithCounterpart(string counterpartAddress)
        {
        ...
        /// <summary>
        /// Validates these XEP-17 transfers.
        /// </summary>
        /// <exception cref="InvalidOperationException">If validation fails</exception>
        public void Validate()
        {
            if (string.IsNullOrEmpty(Address))
                throw new InvalidOperationException("XEP-17 transfers address cannot be null or empty.");
        ...
        public string ToDetailedString()
        {
            ...
            var result = $"XEP-17 Transfers for {Address}:\n";
        ...
        {
            return $"Xep17Transfers(Address: {Address}, Sent: {SentCount}, Received: {ReceivedCount})";
        }
    ...
    /// <summary>
    /// Represents a single XEP-17 token transfer.
    /// </summary>
    [System.Serializable]
    public class Xep17Transfer
    {
        #region Properties
        ...
        /// Default constructor for JSON deserialization.
        /// </summary>
        public Xep17Transfer()
        {
        }
        
        /// <summary>
        /// Creates a new XEP-17 transfer.
        /// </summary>
        ...
        public Xep17Transfer(long timestamp, Hash160 assetHash, string transferAddress, string amount,
        ...
        /// <summary>
        /// Validates this XEP-17 transfer.
        /// </summary>
        /// <exception cref="InvalidOperationException">If validation fails</exception>
        public void Validate()
        {
            if (AssetHash == null)
                throw new InvalidOperationException("XEP-17 transfer asset hash cannot be null.");
            
            if (TxHash == null)
                throw new InvalidOperationException("XEP-17 transfer transaction hash cannot be null.");
            
            if (string.IsNullOrEmpty(Amount))
                throw new InvalidOperationException("XEP-17 transfer amount cannot be null or empty.");
            
            if (string.IsNullOrEmpty(TransferAddress))
                throw new InvalidOperationException("XEP-17 transfer address cannot be null or empty.");
            
            if (BlockIndex < 0)
                throw new InvalidOperationException("XEP-17 transfer block index cannot be negative.");
            
            if (TransferNotifyIndex < 0)
                throw new InvalidOperationException("XEP-17 transfer notify index cannot be negative.");
            
            // Validate amount is a valid number
            if (!decimal.TryParse(Amount, out _))
                throw new InvalidOperationException($"XEP-17 transfer amount is not a valid number: {Amount}");
        }
        ...
        public override string ToString()
        {
            ...
            return $"Xep17Transfer({Amount} {hashPreview} ↔ {addressPreview})";
        }
    ...
    /// <summary>
    /// Contains statistical information about XEP-17 transfers.
    /// </summary>
    [System.Serializable]
    public class TransferStatistics
    {
        ...
        public Xep17Transfer EarliestTransfer { get; set; }
        
        /// <summary>The latest transfer</summary>
        public Xep17Transfer LatestTransfer { get; set; }
