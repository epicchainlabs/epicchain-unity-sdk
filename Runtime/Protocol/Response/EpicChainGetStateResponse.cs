...
namespace EpicChain.Unity.SDK.Protocol.Response
{
    ...
    public class EpicChainGetStateResponse : EpicChainResponse<string>
    {
        ...
        /// </summary>
        public EpicChainGetStateResponse() : base()
        {
        }
        ...
        public EpicChainGetStateResponse(string state, int id = 1) : base(state, id)
        {
        }
        ...
        /// <param name="id">The request ID</param>
        public EpicChainGetStateResponse(ResponseError error, int id = 1) : base(error, id)
        {
        }
        ...
        public override string ToString()
        {
            ...
            if (!HasState)
                return "EpicChainGetStateResponse(No State)";

            return $"EpicChainGetStateResponse(State: {GetShortState()}, Size: {EstimatedSizeBytes} bytes)";
        }
        ...
        public bool StateEquals(EpicChainGetStateResponse other)
        {
            if (other == null)
                return false;
        ...
        /// <returns>New EpicChainGetStateResponse instance</returns>
        public EpicChainGetStateResponse WithState(string newState)
        {
            return new EpicChainGetStateResponse(newState, Id);
        }
