...
using UnityEngine;
using EpicChainUnityCryptography;

namespace EpicChainUnityProtocol.Response
{
    /// <summary>
    /// Represents a XEP-17 token contract with metadata
    /// </summary>
    [Serializable]
    public struct Xep17Contract : IEquatable<Xep17Contract>
    {
        ...
        /// <summary>
        /// Initializes a new instance of Xep17Contract
        /// </summary>
        /// <param name="scriptHash">Contract script hash as string</param>
        /// <param name="symbol">Token symbol</param>
        /// <param name="decimals">Number of decimal places</param>
        [JsonConstructor]
        public Xep17Contract(string scriptHash, string symbol, int decimals)
        {
        ...
        /// <summary>
        /// Initializes a new instance of Xep17Contract with Hash160
        /// </summary>
        /// <param name="scriptHash">Contract script hash</param>
        /// <param name="symbol">Token symbol</param>
        /// <param name="decimals">Number of decimal places</param>
        public Xep17Contract(Hash160 scriptHash, string symbol, int decimals)
        {
        ...
        /// <summary>
        /// Validates all fields of this XEP-17 contract
        /// </summary>
        ...
        public bool Equals(Xep17Contract other)
        {
        ...
        {
            return obj is Xep17Contract other && Equals(other);
        }
        ...
        public static bool operator ==(Xep17Contract left, Xep17Contract right)
        {
        ...
        {
            return $"Xep17Contract({_symbol}, {_scriptHash}, {_decimals} decimals)";
        }
    }
}