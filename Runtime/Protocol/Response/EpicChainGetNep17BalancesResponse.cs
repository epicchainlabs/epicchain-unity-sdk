...
{
    /// <summary>
    /// Response for getting XEP-17 token balances for an address.
    ...
    public class EpicChainGetXep17BalancesResponse : EpicChainResponse<Xep17Balances>
    {
        ...
        /// </summary>
        /// <returns>XEP-17 balances or null if response failed</returns>
        public Xep17Balances GetBalances()
        {
    ...
    /// <summary>
    /// Represents all XEP-17 token balances for a specific address.
    /// </summary>
    [System.Serializable]
    public class Xep17Balances
    {
        #region Properties
        ...
        /// <summary>List of XEP-17 token balances</summary>
        [JsonProperty("balance")]
        public List<Xep17Balance> Balances { get; set; }
        ...
        /// </summary>
        public Xep17Balances()
        {
            Balances = new List<Xep17Balance>();
        }
        
        /// <summary>
        /// Creates new XEP-17 balances.
        /// </summary>
        /// <param name="address">The address</param>
        /// <param name="balances">The token balances</param>
        public Xep17Balances(string address, List<Xep17Balance> balances = null)
        {
            Address = address;
            Balances = balances ?? new List<Xep17Balance>();
        }
        ...
        public Xep17Balance GetBalance(Hash160 assetHash)
        {
        ...
        /// <returns>The balance or null if not found</returns>
        public Xep17Balance GetBalance(string assetHashString)
        {
        ...
        /// <returns>The balance or null if not found</returns>
        public Xep17Balance GetBalanceBySymbol(string symbol)
        {
        ...
        /// <returns>The balance or null if not found</returns>
        public Xep17Balance GetBalanceByName(string name)
        {
        ...
        public List<Xep17Balance> GetNonZeroBalances()
        {
            if (!HasBalances)
                return new List<Xep17Balance>();
        ...
        public List<Xep17Balance> GetZeroBalances()
        {
            if (!HasBalances)
                return new List<Xep17Balance>();
        ...
        public List<Xep17Balance> GetBalancesSortedByAmount()
        {
            if (!HasBalances)
                return new List<Xep17Balance>();
        ...
        public List<Xep17Balance> GetBalancesSortedByLastUpdate()
        {
            if (!HasBalances)
                return new List<Xep17Balance>();
        ...
        /// <summary>
        /// Validates these XEP-17 balances.
        /// </summary>
        /// <exception cref="InvalidOperationException">If validation fails</exception>
        public void Validate()
        {
            if (string.IsNullOrEmpty(Address))
                throw new InvalidOperationException("XEP-17 balances address cannot be null or empty.");
        ...
        {
            var result = $"XEP-17 Balances for {Address}:\n";
        ...
        {
            return $"Xep17Balances(Address: {Address}, Tokens: {TokenCount}, NonZero: {NonZeroTokenCount})";
        }
    ...
    /// <summary>
    /// Represents a single XEP-17 token balance.
    /// </summary>
    [System.Serializable]
    public class Xep17Balance
    {
        #region Properties
        ...
        public Xep17Balance(string name, string symbol, string decimals, string amount, long lastUpdatedBlock, Hash160 assetHash)
        {
            Name = name;
            Symbol = symbol;
            Decimals = decimals;
        ...
        /// <summary>
        /// Validates this XEP-17 balance.
        /// </summary>
        /// <exception cref="InvalidOperationException">If validation fails</exception>
        public void Validate()
        {
            if (AssetHash == null)
                throw new InvalidOperationException("XEP-17 balance asset hash cannot be null.");
            
            if (string.IsNullOrEmpty(Amount))
                throw new InvalidOperationException("XEP-17 balance amount cannot be null or empty.");
            
            if (LastUpdatedBlock < 0)
                throw new InvalidOperationException("XEP-17 balance last updated block cannot be negative.");
            
            // Validate amount is a valid number
            if (!decimal.TryParse(Amount, out _))
                throw new InvalidOperationException($"XEP-17 balance amount is not a valid number: {Amount}");
            
            // Validate decimals if provided
            if (!string.IsNullOrEmpty(Decimals) && !int.TryParse(Decimals, out var decimals))
                throw new InvalidOperationException($"XEP-17 balance decimals is not a valid integer: {Decimals}");
        }
        ...
        public int CompareAmountTo(Xep17Balance other)
        {
            if (other == null)
                return 1;
        ...
        /// <param name="other">The other balance</param>
        /// <returns>Comparison result</returns>
        public int CompareLastUpdateTo(Xep17Balance other)
        {
            if (other == null)
                return 1;
        ...
        public override string ToString()
        {
            ...
            return $"Xep17Balance({DisplayName}: {formattedAmount})";
        }
