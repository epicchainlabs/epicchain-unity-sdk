...
namespace EpicChain.Unity.SDK.Protocol.Response
{
    ...
    public class EpicChainGetMemPoolResponse : NeoResponse<EpicChainGetMemPoolResponse.MemPoolDetails>
    {
        ...
        /// </summary>
        public EpicChainGetMemPoolResponse() : base()
        {
        }
        ...
        public EpicChainGetMemPoolResponse(MemPoolDetails memPoolDetails, int id = 1) : base(memPoolDetails, id)
        {
        }
        ...
        /// <param name="id">The request ID</param>
        public EpicChainGetMemPoolResponse(ResponseError error, int id = 1) : base(error, id)
        {
        }
