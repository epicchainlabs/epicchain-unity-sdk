...
{
    /// <summary>
    /// Response for GetXep11Transfers RPC method.
    ...
    public class EpicChainGetXep11TransfersResponse : NeoResponse<EpicChainGetXep11TransfersResponse.Xep11Transfers>
    {
        ...
        /// </summary>
        [System.Serializable]
        public class Xep11Transfers
        {
            /// <summary>The address these transfers belong to</summary>
            [JsonProperty("address")]
            public string Address { get; set; }
            
            /// <summary>List of XEP-11 transfers sent from this address</summary>
            [JsonProperty("sent")]
            public List<Xep11Transfer> Sent { get; set; }
            
            /// <summary>List of XEP-11 transfers received by this address</summary>
            [JsonProperty("received")]
            public List<Xep11Transfer> Received { get; set; }
            
            /// <summary>
            /// Default constructor.
            /// </summary>
            public Xep11Transfers()
            {
                Sent = new List<Xep11Transfer>();
                Received = new List<Xep11Transfer>();
            }
            ...
            public List<Xep11Transfer> GetAllTransfers()
            {
                var allTransfers = new List<Xep11Transfer>();
            ...
            public List<Xep11Transfer> GetTransfersForContract(Hash160 assetHash)
            {
                var contractTransfers = new List<Xep11Transfer>();
            ...
            /// <summary>
            /// String representation of XEP-11 transfers.
            /// </summary>
            /// <returns>String representation</returns>
            public override string ToString()
            {
                return $"Xep11Transfers(Address: {Address}, Sent: {Sent?.Count ?? 0}, Received: {Received?.Count ?? 0})";
            }
        }
        
        /// <summary>
        /// Individual XEP-11 token transfer record.
        /// </summary>
        [System.Serializable]
        public class Xep11Transfer
        {
            ...
            public override string ToString()
            {
                return $"Xep11Transfer(TokenID: {TokenId}, From: {From}, To: {To}, TxHash: {TransactionHash})";
            }
        }
