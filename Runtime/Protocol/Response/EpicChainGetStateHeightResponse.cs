...
namespace EpicChain.Unity.SDK.Protocol.Response
{
    ...
    public class EpicChainGetStateHeightResponse : NeoResponse<EpicChainGetStateHeightResponse.StateHeight>
    {
        ...
        /// </summary>
        public EpicChainGetStateHeightResponse() : base()
        {
        }
        ...
        public EpicChainGetStateHeightResponse(StateHeight stateHeight, int id = 1) : base(stateHeight, id)
        {
        }
        ...
        /// <param name="id">The request ID</param>
        public EpicChainGetStateHeightResponse(ResponseError error, int id = 1) : base(error, id)
        {
        }
