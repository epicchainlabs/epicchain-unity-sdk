...
namespace EpicChain.Unity.SDK.Protocol.Response
{
    ...
    public class EpicChainGetProofResponse : EpicChainResponse<string>
    {
        ...
        /// </summary>
        public EpicChainGetProofResponse() : base()
        {
        }
        ...
        public EpicChainGetProofResponse(string proof, int id = 1) : base(proof, id)
        {
        }
        ...
        /// <param name="id">The request ID</param>
        public EpicChainGetProofResponse(ResponseError error, int id = 1) : base(error, id)
        {
        }
        ...
        public override string ToString()
        {
            ...
            return $"EpicChainGetProofResponse(Proof: {GetShortProof()}, Size: {EstimatedSizeBytes} bytes)";
        }
        ...
        public bool ProofEquals(EpicChainGetProofResponse other)
        {
            if (other == null)
                return false;
        ...
        /// <returns>New EpicChainGetProofResponse instance</returns>
        public EpicChainGetProofResponse WithProof(string newProof)
        {
            return new EpicChainGetProofResponse(newProof, Id);
        }
    }
}