...
All notable changes to the EpicChain Unity SDK will be documented in this file.
...
- Base58 encoding with EpicChain checksum validation
- XEP-2 encrypted private key support
...
### Changed
- Converted from Swift EpicChainSwift SDK to Unity C# implementation
...
*Note: This SDK maintains full feature parity with the original EpicChainSwift SDK while adding Unity-specific optimizations and enhancements.*