# Contributing to EpicChain Unity SDK 🤝

We welcome contributions from the community! This guide will help you get started with contributing to the EpicChain Unity SDK.
...
git clone https://github.com/your-username/epicchain-unity-sdk.git
cd epicchain-unity-sdk

# 2. Open in Unity
# Open Unity Hub → Add → Select the epicchain-unity-sdk folder
...
```csharp
/// <summary>
/// Gets the balance of a XEP-17 token for the specified account.
/// </summary>
